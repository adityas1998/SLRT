...
def build_parser():
    ...
    parser.add_argument(
        "--pretrained", type=str, default="../I3D_feature_extractor/chpt/bsl5k.pth.tar", help="path to pretrained model file"
    )
    parser.add_argument(
        "--evaluate_video",
        type=int,
    ...
    parser.add_argument("--datasetname", type=str, default="H2S",help="datasetname")
    parser.add_argument(
        "--featurize_mode",
        type=int,
        default=0,
